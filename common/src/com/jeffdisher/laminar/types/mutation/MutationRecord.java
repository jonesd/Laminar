...
public class MutationRecord {
	public static MutationRecord createTopic(long termNumber, long globalOffset, TopicName topic, UUID clientId, long clientNonce, byte[] code, byte[] arguments) {
		...
		return new MutationRecord(MutationRecordType.CREATE_TOPIC, termNumber, globalOffset, topic, clientId, clientNonce, MutationRecordPayload_CodeAndArguments.create(code, arguments));
	}
	...
	private static MutationRecord _deserializeFrom(ByteBuffer buffer) {
		...
		case CREATE_TOPIC:
			payload = MutationRecordPayload_CodeAndArguments.deserialize(buffer);
			break;
		case DESTROY_TOPIC:
